...
const redirectToWhatsapp = (customerMessage?:string ) => {

    let message;
    
    if (customerMessage){
        message = `Jai Jagannath! I am interested in your services.
        -----------------
    ...
    const wp_url = `https://wa.me/917008096589/?text=${encodedMessage}`;
